        ...
        <div class="container">
            ...
            <div class="row p-3">
                ...
                <div class="col-3">
                    ...
                    <vc:render component="icon" name="0-circle" />
                    <vc:render component="icon" name="1-circle" />
                    <vc:render component="icon" name="2-circle" />
                    <vc:render component="icon" name="0-square" />
                    <vc:render component="icon" name="1-square" />
                    <vc:render component="icon" name="2-square" />
